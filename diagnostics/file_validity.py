...
def check_pptx_file(filename):
    ...
    try:
        ...
        print(f"  ❌ Invalid ZIP structure - file is corrupted")
        return False
    ...
    try:
        ...
        print(f"  ✅ python-pptx can read it")
