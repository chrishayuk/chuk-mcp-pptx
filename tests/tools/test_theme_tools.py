...
class TestApplyComponentTheme:
    ...
    @pytest.mark.asyncio
    async def test_apply_component_theme_default_style(self, theme_tools, mock_presentation_manager):
    ...
    @pytest.mark.asyncio
    async def test_apply_component_theme_no_presentation(self, theme_tools, mock_presentation_manager):
