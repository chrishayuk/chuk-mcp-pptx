...
class TestAddSlideWithLayout:
    ...
    @pytest.mark.asyncio
    async def test_add_slide_with_layout_invalid_index(self, layout_tools, mock_presentation_manager):
    ...
    @pytest.mark.asyncio
    async def test_add_slide_with_layout_no_presentation(self, layout_tools, mock_presentation_manager):
        """Test error when no presentation."""
        mock_presentation_manager.get.return_value = None
        result = await layout_tools['pptx_add_slide_with_layout'](
            layout_index=1
    ...
    @pytest.mark.asyncio
    async def test_add_slide_with_layout_content_string(self, layout_tools, mock_presentation_manager):
...
class TestCustomizeLayout:
    ...
    @pytest.mark.asyncio
    async def test_customize_layout_color_without_hash(self, layout_tools, mock_presentation_manager):
...
class TestApplyMasterLayout:
    ...
    @pytest.mark.asyncio
    async def test_apply_master_layout_no_presentation(self, layout_tools, mock_presentation_manager):
        """Test error when no presentation."""
        mock_presentation_manager.get.return_value = None
        result = await layout_tools['pptx_apply_master_layout'](
            layout_name="corporate"
    ...
    @pytest.mark.asyncio
    async def test_apply_master_layout_invalid_colors(self, layout_tools, mock_presentation_manager):
    ...
    @pytest.mark.asyncio
    async def test_apply_master_layout_colors_without_hash(self, layout_tools, mock_presentation_manager):
...
class TestIntegration:
    ...
    async def test_only_expected_tools_registered(self, layout_tools):
        ...
        expected_count = 6
        assert len(layout_tools) == expected_count, f"Expected {expected_count} tools, got {len(layout_tools)}"

    @pytest.mark.asyncio
    async def test_workflow_create_customize_duplicate(self, layout_tools, mock_presentation_manager):
        ...
        # Duplicate it
        result3 = await layout_tools['pptx_duplicate_slide'](
            slide_index=0
        )
