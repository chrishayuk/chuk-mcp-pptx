...
def format_text_frame(text_frame, font_name: str = None, font_size: int = None,
...
def validate_text_fit(shape, text: str = None, font_size: int = None) -> Dict[str, Any]:
    """
    ...
    if not shape.has_text_frame:
        return {
            "fits": False,
            "error": "Shape does not have text frame"
        }
