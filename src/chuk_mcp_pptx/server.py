...
# Import everything from async server (includes all registered tools)
...
def main():
    ...
    if args.mode == "stdio":
        ...
        print(f"PowerPoint MCP Server starting in HTTP mode on {args.host}:{args.port}", file=sys.stderr)
