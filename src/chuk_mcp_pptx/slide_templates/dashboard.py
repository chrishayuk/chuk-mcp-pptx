...
@template(
    ...
    props=[
        ...
        TemplateProp("metrics", "array", "List of metrics with label, value, optional change and trend"),
        TemplateProp("layout", "string", "Layout style", required=False,
                     options=["grid", "row"], default="grid"),
