...
class DomainChartGallery:
    ...
    async def create_finance_charts(self, prs: Presentation, theme_name: str):
        ...
        combo = ComboChart(
            ...
            column_series={
                "Revenue": [420, 445, 468, 495, 510, 535]
            },
            line_series={
    ...
    async def create_hr_charts(self, prs: Presentation, theme_name: str):
        ...
        headcount = BarChart(
            ...
            series={
                "2022": [120, 85, 45, 60, 25, 30],
                "2023": [145, 95, 52, 68, 28, 35]
            },
            variant="clustered",
    ...
    async def create_project_mgmt_charts(self, prs: Presentation, theme_name: str):
        ...
        progress = BarChart(
            ...
            series={
                "Completed": [100, 85, 45, 10],
                "Remaining": [0, 15, 55, 90]
            },
            variant="stacked",
    ...
    async def generate_all_themes(self):
        ...
        print("=" * 70)
        print(f"Creating {len(self.available_themes)} themes × {len(domains)} domains = "
...
async def main():
    ...
    output_dir = await gallery.generate_all_themes()
